...
class Puzzle {
  ...
  public void Generate()
  {
    ...
    for ( TableRow row : puzzleData.rows () )
    {
      ...
      this.pGrid.nodeList[nodeIndex].setOutput(true);
    ...
    // INVERTER
    blockBank.add(new Block(BLOCK.INVERTER, wSize-(bbWidth*gSize)/2 - 3.25*gSize - 1*gSize, (8*gSize)/2));

    // MIXER
    blockBank.add(new Block(BLOCK.MIXER, wSize-(bbWidth*gSize)/2 - 3.25*gSize - 1*gSize, (18*gSize)/2));

    //DEMIXER
    blockBank.add(new Block(BLOCK.DEMIXER, wSize-(bbWidth*gSize)/2 + 0.75*gSize - 1*gSize, (18*gSize)/2));

    // DECONSTRUCTOR
    blockBank.add(new Block(BLOCK.DECONSTRUCTOR, wSize-(bbWidth*gSize)/2 + 0.75*gSize - 1*gSize, (8*gSize)/2));
    
    // SPLITTER
    blockBank.add(new Block(BLOCK.SPLITTER, wSize-(bbWidth*gSize)/2 - 3.25*gSize - 1*gSize, (28*gSize)/2));
  ...
  public void Display()
  {
    ...
    text("Inverter", wSize-(bbWidth*gSize)/2 - 3.25*gSize - 1*gSize, (4*gSize)/2);
    text("Mixer", wSize-(bbWidth*gSize)/2 - 3.25*gSize - 1*gSize, (14*gSize)/2);
    text("Demixer",wSize-(bbWidth*gSize)/2 + 0.75*gSize - 1*gSize, (14*gSize)/2);
    text("Deconstructor", wSize-(bbWidth*gSize)/2 + 0.75*gSize - 1*gSize, (4*gSize)/2);
    text("Splitter", wSize-(bbWidth*gSize)/2 - 3.25*gSize - 1*gSize, (24*gSize)/2);
