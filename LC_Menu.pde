...
class Menu 
{
  ...
  public Menu(int type)
  {
    ...
    if (type == MENU)
    {
      ...
      // Create Buttons
      playBtn = new Button(hSize/10, wSize/5, wSize/2, (hSize*5)/9, color(00, 22, 44), color(255), "Play Game");
      exitBtn = new Button(hSize/10, wSize/5, wSize/2, (hSize*5)/9 + 2*gSize + 2*75, color(00, 22, 44), color(255), "Exit Game");
      tutBtn = new Button(hSize/10, wSize/5, wSize/2, (hSize*5)/9 +gSize + 75, color(00, 22, 44), color(255), "Tutorial");
    } 
	...
	else if (type == TUTORIAL)
    {
      ...
      menuBtn = new Button(hSize/10, wSize/5, wSize/2, (hSize*9)/10, color(00, 22, 44), color(255), "Go Back");
    }
  }
  ...
  public void Display()
  {
    if (type == MENU)
    {
      ...
      text("LogiColour: A Colourful Puzzle Game", wSize/2, hSize/3);
      playBtn.Display();
      tutBtn.Display();
      exitBtn.Display();
