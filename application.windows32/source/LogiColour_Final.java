...
public class LogiColour_Final extends PApplet {
...
// Grid Size (in Grid Nodes)
final int gWidth = 30;
final int gHeight = 20;

// Block Bank Size (in Grid Nodes)
final int bbHeight = 0;
final int bbWidth = 12;

// Window Size (in Pixels)
final int wSize = gSize*(gWidth + bbWidth);
final int hSize = gSize*(gHeight + bbHeight + 2);
...
class Wire
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "LogiColour_Final" };
    if (passedArgs != null) {
